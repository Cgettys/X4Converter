...
//	}
    ...
    if (action == "importxmf") {
      ...
      ConvertDaeToXml(ctx, inFile.generic_string(), outFile.generic_string());

    } else {
      printf("Unknown action.\n\n");
      printf(
          "Usage: X4ConvertersMain <action> <folder with .dat file contents> <.xml/.dae file> <extensions folder (optional)>\n");
      std::cout << visible << "\n";
      return 1;
    }
