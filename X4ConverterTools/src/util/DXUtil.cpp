...
Vec3D DXUtil::ConvertVertexAttributeToVec3D(byte *pAttribute, D3DDECLTYPE type) {
    switch (type) {
        ...
        case D3DDECLTYPE_D3DCOLOR:
            return Vec3D(((float) pAttribute[2] / 255.0f) * 2.0f - 1.0f, ((float) pAttribute[1] / 255.0f) * 2.0f - 1.0f,
        ...
        case D3DDECLTYPE_USHORT2N:
            return Vec3D((float) ((ushort *) pAttribute)[0] / 65535.0f, (float) ((ushort *) pAttribute)[1] / 65535.0f,
                         0.0f);
...
aiColor4D DXUtil::ConvertVertexAttributeToColorF(byte *pAttribute, D3DDECLTYPE type) {
    switch (type) {
        case D3DDECLTYPE_FLOAT3:
            return (aiColor4D) Color(((float *) pAttribute)[0], ((float *) pAttribute)[1], ((float *) pAttribute)[2],
                                     1.0f);
