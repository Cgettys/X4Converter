...
private:
    ...
    void
    ReadPart(pugi::xml_node partNode, const boost::filesystem::path &geometryFolderPath, Assimp::IOSystem *pIOHandler);

    void CreateDummyFile(const std::string &filePath, const std::string &gameBaseFolderPath);

    void
    WritePart(ComponentPart &part, pugi::xml_node connectionsNode, const boost::filesystem::path &geometryFolderPath,
    ...
    void WritePartLods(ComponentPart &part, pugi::xml_node partNode, const boost::filesystem::path &geometryFolderPath,
                       Assimp::IOSystem *pIOHandler);
};
