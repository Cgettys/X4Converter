...
namespace xmf {
    ...
    public:
        ...
        uint8_t RightHand;                     // byte       13; 0 == lefthand D3D convention, other is righthand openGL format todo validate
        ...
        const static uint8_t EXPECTED_HEADER_SIZE = 0x40;// If it's not 0x40 we have an issue
