...
// TODO extract some permanent test files
    BOOST_AUTO_TEST_CASE(test_xmf_header) {
        ...
        uint8_t bytes[] = {
                ...
                0xDE, 0xAD, 0xBE, 0xEF, 0xDE, 0xAD, 0xBE, 0xEF, 0xDE, 0xAD, 0xBE, 0xEF, 0xDE, 0xAD, 0xBE, 0xEF,
        };// extra bytes to make sure it didn't go over
        // TODO does sizeof(bytes) == 96?
        IOStream *pStream = new MemoryIOStream(bytes, 96, false);
